<login>
	...
	<script>
		...
		/* --------------------------------------------------
			...
			this function fires when we log in or log out of the web login button
			2) signInWithPopup()
			3) signOut()
		...
		logIn(event) {
			...
			// Popover signup is probably the most simple and trusted. What we want to happen once they finish the popup
