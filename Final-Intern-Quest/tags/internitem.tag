<internitem>
	<div class="container-fluid">
		<div class="row">
			<pre> Author: { author } <br><strong> Position: </strong> { internPosition } <br><strong> Company: </strong> { internCompany } <br><strong> Length of Time at Internship: </strong> { internLength } <br><strong> Comments:</strong> { internComments } <br><strong> Skills: </strong> { internSkills } <br><strong> Rating: </strong> {rateInternship}
